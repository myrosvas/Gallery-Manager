...
console.log('apiKey ');
 ...
 console.log(groupId);
  ...
  gallery.innerHTML = gallery.getAttribute('data-loading-indicator') || '<img src="flickrgallery/src/assets/img/loading.gif" /> <strong>Please wait...</strong><br>The gallery is loading.';
  ...
  function loadGallery() {
    ...
    req.open('GET', 'https://api.flickr.com/services/rest/?' +
      ...
      console.log('https://api.flickr.com/services/rest/?' +
      'method=flickr.groups.pools.getPhotos&' +
      'format=json&' +
      'nojsoncallback=1&' +
      'media=photos&' +
    ...
    function onLoad() {
      ...
      if (this.status == 200) {
        ...
        try {
          ...
          console.log("JSON parsed response photo[1]: "+ response.photos[1] );
        } catch(e) {
